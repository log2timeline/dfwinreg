...
DPKG_PYTHON3_DEPENDENCIES="libcreg-python3 libregf-python3 python3-dfdatetime python3-dtfabric python3-yaml";
...
RPM_PYTHON3_DEPENDENCIES="libcreg-python3 libregf-python3 python3-dfdatetime python3-dtfabric python3-pyyaml";
