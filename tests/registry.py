...
class RegistryTest(test_lib.BaseTestCase):
    ...
    def testGetKeyByPathOnNTUserDat(self):
        ...
        # Test a non-existing key.
        registry_key = win_registry.GetKeyByPath("HKEY_CURRENT_USER\\Software\\Bogus")
        self.assertIsNone(registry_key)
    ...
    def testGetKeyByPathOnSystem(self):
        ...
        self.assertEqual(registry_key.path, "HKEY_LOCAL_MACHINE\\SYSTEM\\ControlSet001")
        ...
        self.assertEqual(
            registry_key.path, "HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Enum"
        )

        # Test a non-existing key.
        registry_key = win_registry.GetKeyByPath("HKEY_LOCAL_MACHINE\\System\\Bogus")
        self.assertIsNone(registry_key)
